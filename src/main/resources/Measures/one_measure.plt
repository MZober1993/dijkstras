...
plot 'measure_Mixed.csv' using 1:6 with lines title 'alle Messwerte std' ls 1, \
     '' using 1:10 with lines title 'alle Messwerte fibo' ls 2, \
     '' using 1:14 with lines title 'alle Messwerte binary' ls 3, \
