...
public final class FibonacciHeapBig<T> {
    ...
    private static final Logger LOGGER = LoggingHelper.buildLoggerWithStandardOutputConfig(FibonacciHeapBig.class);
     ...
     * @return A new FibonacciHeapBig containing all of the elements of both
     * heaps.
     */
    public static <T> FibonacciHeapBig<T> merge(FibonacciHeapBig<T> one, FibonacciHeapBig<T> two) {
        FibonacciHeapBig<T> result = new FibonacciHeapBig<>();
    ...
    public String toString() {
        ...
        builder.append("FibonacciHeapBig{" + "minimum=").append(minimum).append(", size=").append(size).append("[\n");
